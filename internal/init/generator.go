...
func writeHeader(sb *strings.Builder) {
	...
	sb.WriteString("# Documentation: https://github.com/Jonathangadeaharder/structurelint\n\n")
...
func GenerateSummary(info *ProjectInfo) string {
	...
	sb.WriteString("🔍 Project Analysis Summary\n")
	sb.WriteString("===========================\n\n")
	...
	switch info.DocumentationStyle {
	case "comprehensive":
		sb.WriteString("  ✓ Comprehensive (READMEs in most directories)\n")
	case "minimal":
		sb.WriteString("  ⚠ Minimal (few READMEs found)\n")
	case "none":
		sb.WriteString("  ✗ None (no READMEs found)\n")
	}
	sb.WriteString("\n")
	...
	if info.DocumentationStyle == "none" {
		sb.WriteString("  ⚠ Consider adding README.md files to document your code\n")
	}

	if info.MaxDepth > 8 {
		sb.WriteString("  ⚠ Deep nesting detected. Consider flattening directory structure\n")
	}
