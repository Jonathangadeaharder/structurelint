...
func (r *MaxCognitiveComplexityRule) analyzeFileWithMax(file walker.FileInfo, analyzer *metrics.CognitiveComplexityAnalyzer, maxComplexity int) []rules.Violation {
	var violations []rules.Violation
...
func (r *MaxCognitiveComplexityRule) analyzeMultiLangFileWithMax(file walker.FileInfo, analyzer *metrics.AnalyzerV2, maxComplexity int) []rules.Violation {
	var violations []rules.Violation
