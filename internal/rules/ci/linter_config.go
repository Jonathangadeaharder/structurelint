...
func (r *LinterConfigRule) Check(files []walker.FileInfo, dirs map[string]*walker.DirInfo) []rules.Violation {
...
func (r *LinterConfigRule) checkLanguageLinters(files []walker.FileInfo, config LinterConfig) []rules.Violation {
	var violations []rules.Violation
