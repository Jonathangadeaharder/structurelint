...
func (r *ContractFrameworkRule) Check(files []walker.FileInfo, dirs map[string]*walker.DirInfo) []rules.Violation {
...
func (r *ContractFrameworkRule) checkLanguageContracts(files []walker.FileInfo, config ContractFrameworkConfig) []rules.Violation {
	var violations []rules.Violation
