...
func (r *GitHubWorkflowsRule) Check(files []walker.FileInfo, dirs map[string]*walker.DirInfo) []rules.Violation {
...
func (r *GitHubWorkflowsRule) findWorkflowFiles(files []walker.FileInfo) []walker.FileInfo {
...
func (r *GitHubWorkflowsRule) parseWorkflows(files []walker.FileInfo) map[string]*rules.WorkflowFile {
	workflows := make(map[string]*rules.WorkflowFile)
	...
	for _, file := range files {
		...
		var workflow rules.WorkflowFile
...
func (r *GitHubWorkflowsRule) hasWorkflowType(workflows map[string]*rules.WorkflowFile, workflowType string, keywords []string) bool {
...
func (r *GitHubWorkflowsRule) validateWorkflow(path string, workflow *rules.WorkflowFile) []rules.Violation {
	var violations []rules.Violation
...
func (r *GitHubWorkflowsRule) validateTriggers(path string, workflow *rules.WorkflowFile) []rules.Violation {
	var violations []rules.Violation
...
func (r *GitHubWorkflowsRule) hasJob(workflow *rules.WorkflowFile, pattern string) bool {
	for jobName := range workflow.Jobs {
...
func (r *GitHubWorkflowsRule) validateJob(path, jobName string, job rules.WorkflowJob) []rules.Violation {
	var violations []rules.Violation
...
func (r *GitHubWorkflowsRule) hasLogCommitSteps(job rules.WorkflowJob) bool {
...
func (r *GitHubWorkflowsRule) hasRepomixArtifactSteps(job rules.WorkflowJob) bool {
	hasRepomixRun := false
...
func (r *GitHubWorkflowsRule) generateWorkflowAutoFix(rootDir string, workflowType string) *rules.AutoFix {
