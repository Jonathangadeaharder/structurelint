...
func (r *PropertyEnforcementRule) Check(files []walker.FileInfo, dirs map[string]*walker.DirInfo) []rules.Violation {
	if r.Graph == nil {
...
func (r *PropertyEnforcementRule) detectCycles() []rules.Violation {
...
func (pcd *propertyCycleDetector) recordCycleViolation(file, depFile string) {
	...
	pcd.violations = append(pcd.violations, rules.Violation{
		Rule:    pcd.rule.Name(),
		Path:    file,
...
func (r *PropertyEnforcementRule) checkMaxDependencies() []rules.Violation {
	var violations []rules.Violation
...
func (r *PropertyEnforcementRule) checkDependencyDepth() []rules.Violation {
	var violations []rules.Violation
...
func (r *PropertyEnforcementRule) checkForbiddenPatterns() []rules.Violation {
	var violations []rules.Violation
