...
func (r *TestLocationRule) Check(files []walker.FileInfo, dirs map[string]*walker.DirInfo) []rules.Violation {
...
func (r *TestLocationRule) checkFile(file walker.FileInfo, sourceFiles map[string]bool) *rules.Violation {
