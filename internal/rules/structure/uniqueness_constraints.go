...
func (r *UniquenessConstraintsRule) Check(files []walker.FileInfo, dirs map[string]*walker.DirInfo) []rules.Violation {
...
func (r *UniquenessConstraintsRule) checkSingletonConstraint(dir string, files []walker.FileInfo, pattern string) []rules.Violation {
	var violations []rules.Violation
